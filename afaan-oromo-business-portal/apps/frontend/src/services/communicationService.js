...
const MOCK_MESSAGES = [
  {
    ...
    senderDepartment: 'Commercial Office',
  ...
  },
  {
    ...
    senderDepartment: 'Addaf Turizm Biro',
  ...
  },
  {
    ...
    senderName: 'IT Admin',
    senderDepartment: 'IT Biro',
    applicationNumber: null,
    body: 'This week we processed 45 applications. Commercial Office approved 28, rejected 5. Addaf Turizm approved 22, rejected 3. Overall system performance is optimal.',
...
/**
 * Get Communication Biro dashboard statistics
 */
...
/**
 * Get applications from Commercial Office (completed reviews)
 */
...
/**
 * Get applications from Addaf Turizm Biro (completed reviews)
 */
