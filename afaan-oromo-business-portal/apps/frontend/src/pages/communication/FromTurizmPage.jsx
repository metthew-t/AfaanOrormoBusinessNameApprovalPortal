  ...
  return (
    <div className={styles.page}>
      <div className="page-header">
        <h1>📨 Messages from Addaf Turizm Biro</h1>
        <p>Review language assessment results and make final approval decisions</p>
      </div>
      ...
      {applications.length === 0 ? (
        <EmptyState
          ...
          message="Language assessment results from Addaf Turizm Biro will appear here"
        />
      ) : (
