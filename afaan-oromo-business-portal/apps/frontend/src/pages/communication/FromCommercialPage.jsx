  ...
  return (
    <div className={styles.page}>
      <div className="page-header">
        <h1>📨 Messages from Commercial Office</h1>
        <p>Review permit assessment results and make final approval decisions</p>
      </div>
      ...
      {applications.length === 0 ? (
        <EmptyState
          ...
          message="Permit assessment results from Commercial Office will appear here"
        />
      ) : (
