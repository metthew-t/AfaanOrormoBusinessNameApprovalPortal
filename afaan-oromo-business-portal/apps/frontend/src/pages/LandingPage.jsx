      ...
      <section className={styles.features}>
        <div className={styles.sectionContainer}>
          ...
          <div className={styles.featureGrid}>
            ...
            <div className={styles.featureCard}>
              <div className={styles.featureIcon}>🔄</div>
              <h3 className={styles.featureTitle}>Communication Biro Review</h3>
              <p className={styles.featureDescription}>
            ...
            <div className={styles.featureCard}>
              <div className={styles.featureIcon}>🏢</div>
              <h3 className={styles.featureTitle}>Commercial Office Review</h3>
              <p className={styles.featureDescription}>
            ...
            <div className={styles.featureCard}>
              <div className={styles.featureIcon}>🌍</div>
              <h3 className={styles.featureTitle}>Addaf Turizm Biro Review</h3>
              <p className={styles.featureDescription}>
        ...
        <div className={styles.sectionContainer}>
          ...
          <div className={styles.rolesGrid}>
            ...
            <div className={styles.roleCard}>
              <div className={styles.roleHeader}>
                <div className={styles.roleIcon}>📡</div>
                <h3 className={styles.roleTitle}>Communication Biro</h3>
              </div>
              <ul className={styles.roleFeatures}>
            ...
            <div className={styles.roleCard}>
              <div className={styles.roleHeader}>
                ...
                <h3 className={styles.roleTitle}>Commercial Office</h3>
              </div>
              <ul className={styles.roleFeatures}>
            ...
            <div className={styles.roleCard}>
              <div className={styles.roleHeader}>
                <div className={styles.roleIcon}>🌍</div>
                <h3 className={styles.roleTitle}>Addaf Turizm Biro</h3>
              </div>
              <ul className={styles.roleFeatures}>
            ...
            <div className={styles.roleCard}>
              <div className={styles.roleHeader}>
                <div className={styles.roleIcon}>⚙️</div>
                <h3 className={styles.roleTitle}>Admin (IT Biro)</h3>
              </div>
              <ul className={styles.roleFeatures}>
