...
export default function IncomingApplicationsPage() {
  ...
  const handleRoute = async () => {
    ...
    setRouteError(null);
    try {
      // Route the application: description to Waajira Aadaaf Turizimii, permits to Waajira Daldaala
      await route({
      ...
      toast.success('Application routed successfully to Waajira Daldaala and Waajira Aadaaf Turizimii');
