...
export default function AdminSettingsPage() {
  ...
  // Initialize form state when settings load or refresh
  useEffect(() => {
  ...
  const sections = [
    ...
    {
      title: '🌍 Waajira Aadaaf Turizimii (Language Review)',
      fields: [
        { key: 'turizm_dashboard_title', label: 'Dashboard Title', default: 'Waajira Aadaaf Turizimii Dashboard' },
    ...
    {
      title: '🏛️ Waajira Daldaala',
      fields: [
        { key: 'commercial_dashboard_title', label: 'Dashboard Title', default: 'Waajira Daldaala Dashboard' },
    ...
    {
      title: '📡 Waajira Kominikeeshinii',
      fields: [
        { key: 'communication_dashboard_title', label: 'Dashboard Title', default: 'Waajira Kominikeeshinii Dashboard' },
    ...
    {
      title: '👥 User Roles (Labels)',
      fields: [
        { key: 'role_label_BUSINESS_OWNER', label: 'Business Owner Role Name', default: 'Business Owner' },
        { key: 'role_label_FINANCIAL_OFFICER', label: 'Financial Officer Role Name', default: 'Waajira Kominikeeshinii' },
        { key: 'role_label_LANGUAGE_OFFICER', label: 'Language Officer Role Name', default: 'Waajira Aadaaf Turizimii' },
        { key: 'role_label_SENIOR_OFFICER', label: 'Senior Officer Role Name', default: 'Waajira Daldaala' },
        { key: 'role_label_ADMIN', label: 'Admin Role Name', default: 'Administrator (IT Office)' },
      ],
    },
  ];
  ...
  return (
    <div className={styles.container}>
      <form className="card" onSubmit={handleSave} style={{ padding: 0 }}>
        <div className={styles.cardHeader}>
          <h1>⚙️ System Settings</h1>
          <p>Customize dynamic messages, titles, and labels across all dashboards and user interfaces.</p>
        </div>
        ...
        <div style={{ padding: 'var(--space-5)' }}>
          ...
          <div className={styles.actions}>
            ...
            <Button type="submit" disabled={!dirty || loading} size="lg">
