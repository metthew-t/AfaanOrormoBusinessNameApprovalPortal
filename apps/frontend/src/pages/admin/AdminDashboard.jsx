  ...
  return (
    <div className={styles.dashboard}>
      <div className="page-header">
        <h1>Admin (IT Office) Dashboard</h1>
        ...
        <div className={styles.departmentGrid}>
          <div className={styles.deptCard}>
            <div className={styles.deptHeader}>
              ...
              <h4>{getSetting('communication_dashboard_title', 'Waajira Kominikeeshinii')}</h4>
            </div>
          ...
          <div className={styles.deptCard}>
            <div className={styles.deptHeader}>
              ...
              <h4>{getSetting('commercial_dashboard_title', 'Waajira Daldaala')}</h4>
            </div>
            <div className={styles.deptStats}>
              <div className={styles.deptStat}>
          ...
          <div className={styles.deptCard}>
            <div className={styles.deptHeader}>
              <span className={styles.deptIcon}>🌍</span>
              <h4>{getSetting('turizm_dashboard_title', 'Waajira Aadaaf Turizimii')}</h4>
            </div>
            <div className={styles.deptStats}>
              <div className={styles.deptStat}>
