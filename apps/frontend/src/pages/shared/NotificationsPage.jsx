...
export default function NotificationsPage() {
  ...
  const { data: notificationsData, loading, error, refetch } = useAsync(
    () => getNotifications(),
    []
  );

  const list = notificationsData?.notifications || [];
  const unread = notificationsData?.unreadCount || list.filter((n) => !n.isRead).length;
              ...
              >
                ...
                <div className={styles.content}>
                  <div className={styles.titleRow}>
                    ...
                    {!notif.isRead && <span className={styles.dot} aria-label="Unread" />}
                  </div>
