...
import { getTurizmQueue } from '@/services/turizmService';
import { formatDate } from '@/utils/formatters';
import DataTable from '@/components/ui/DataTable';
import StatusBadge from '@/components/ui/StatusBadge';
import Button from '@/components/ui/Button';

export default function TurizmQueuePage() {
  ...
  return (
    <div style={{ maxWidth: 1400 }}>
      <div className="page-header">
        <h1>Language Review Queue</h1>
        <p>Review business descriptions for Afaan Oromo language compliance</p>
      </div>
      ...
      <div className="card">
        <DataTable
          ...
          emptyMessage="All descriptions have been reviewed."
        />
      </div>
    </div>
  );
